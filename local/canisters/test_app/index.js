...
import { idlFactory } from './test_app.did.js';
export { idlFactory } from './test_app.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TEST_APP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test_app.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test_app canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test_app.did.js")._SERVICE>}
 */
export const test_app = createActor(canisterId);
