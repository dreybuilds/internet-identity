...
export const canisterId = process.env.CANISTER_ID_ISSUER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./issuer.did.js")._SERVICE>}
 */
 ...
 */
export const issuer = createActor(canisterId);
